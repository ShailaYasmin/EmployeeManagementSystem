                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Employee
                                        <?php  
                                            $user=$user -> allUserCount();
                                            echo "<h2>Total User: " . $user . "</h2><br/>";
                                         ?>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">User
                                            <?php  
                                                $user=$user -> allUserCount();
                                                echo "<h2>Total Users : " . $user . "</h2><br/>";
                                            ?>
                                        </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    $connection = new mysqli("localhost","root","","test");
                                        if( isset($_POST['search-data']) ){
                                            ...
                                            $sql = "SELECT * FROM  report WHERE ".$s_row." = '" .$s_value."'";
                                         ...
                                         while (($row = mysqli_fetch_array($data, MYSQLI_ASSOC)) != false) {
                                             if($row["STATUS"] == 0){
                                                 $status = "Active";
